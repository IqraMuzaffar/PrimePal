-- Fix missing migrations: achievements table and student_interactions.score column
-- Run this in Supabase SQL Editor to fix database schema issues

-- ============================================================================
-- Migration 026: Create achievements tables
-- ============================================================================
...
-- ============================================================================
-- Migration 028: Add score column to student_interactions
-- ============================================================================
...
-- Relax the interaction_type CHECK constraint to allow new task types
ALTER TABLE student_interactions DROP CONSTRAINT IF EXISTS student_interactions_interaction_type_check;

-- Verify achievements table
SELECT COUNT(*) as achievement_count FROM achievements;

-- Verify score column exists
SELECT column_name FROM information_schema.columns
WHERE table_name = 'student_interactions' AND column_name = 'score';
