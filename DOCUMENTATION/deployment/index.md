...
| File | Description |
|------|-------------|
| [production-deployment.md](production-deployment.md) | **Live production setup** — Vercel + DO App Platform, URLs, doctl commands, troubleshooting |
| [environment-variables.md](environment-variables.md) | All env vars for backend and frontend |
| [docker.md](docker.md) | Docker Compose setup and container details (local dev) |
